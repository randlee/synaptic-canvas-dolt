...
Every imported skill that depends on an external CLI or app should end up with:

- standard install and troubleshooting instructions that work without Synaptic
  Canvas
...
- Add install-and-troubleshooting guidance as a dedicated reference file.
...
- Preserve templates and assets as package artifacts.
- Make sure manifest metadata reflects template files actually used by the
  skill.
...
- topology is settled
- manifest or package metadata matches artifacts
