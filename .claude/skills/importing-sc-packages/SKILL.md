...
2. Inventory artifacts, dependencies, existing install guidance, and package
   boundaries.
...
4. Normalize docs and metadata:
   ...
   - align manifest/plugin metadata with actual artifacts
...
- For fast-moving vendor CLIs, link to official upstream install docs.
...
- required edits
- dependency/install guidance decisions
- missing docs
- import readiness
